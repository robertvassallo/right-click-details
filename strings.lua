	...
	en = {
		...
		mod_desc = "Right-click a town, industry, station or depot for a compact readout, "
			...
			.. "Freight amounts are exact. The line shown beside a commodity is "
				.. "named only when that line is the ONLY one carrying it here - "
				.. "where two or more do, the row reads \"2 lines\" instead, "
				.. "because the game does not record which line a waiting item is "
				.. "queued for. Earlier versions guessed, and named the wrong line "
				.. "at any interchange.\n\n"
