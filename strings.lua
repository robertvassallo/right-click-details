...
return {
	en = {
		...
		mod_desc = "Right-click a town, industry, station or depot for a compact readout, "
			...
			.. "Freight amounts are exact. The line beside a commodity is the only "
			.. "one SEEN carrying it - where two or more are seen the row reads "
			.. "\"2 lines\" and each is listed underneath in its own colour, "
			.. "because the game does not record which line a waiting item is "
			.. "queued for. Read a single name as a good guess rather than a fact: "
			.. "the check looks at what each line has aboard right then, and a line "
			.. "running empty is invisible, so one station can read \"2 lines\" "
			.. "one minute and a single name the next. Earlier versions were worse "
			.. "- they named whichever line was found first and hid the others.\n\n"
			.. "A station served by more than ten lines lists the first ten. The "
			.. "panel is meant to be a glance, not a second window.\n\n"
