...
return {
	en = {
		...
		mod_desc = "Right-click a town, industry, station or depot for a compact readout, "
			...
			.. "Freight amounts are exact. The line beside a commodity is named only "
			.. "when it is the one line here set up to carry it - where two or more "
			.. "are, the row reads \"2 lines\" and each is listed underneath in its "
			.. "own colour, because the game does not record which line an "
			.. "individual waiting crate is queued for.\n\n"
