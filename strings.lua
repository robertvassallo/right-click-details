...
return {
	en = {
		...
		mod_desc = "Right-click a town, industry, station or depot for a compact readout, "
			...
			.. "Freight amounts are exact. The line shown beside a commodity is "
			.. "named only when that line is the ONLY one carrying it here. Where "
			.. "two or more do, the row reads \"2 lines\" and each of them is "
			.. "listed underneath with its own colour, because the game does not "
			.. "record which line a waiting item is queued for. Earlier versions "
			.. "guessed, and named the wrong line at any interchange. On a very "
			.. "busy line a rarely-carried commodity can still slip that check, so "
			.. "read a single named line as very likely rather than certain.\n\n"
