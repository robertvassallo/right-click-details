...
return {
	en = {
		...
		mod_desc = "Right-click a town, industry, station or depot for a compact readout, "
			...
			.. "STATIONS AND STOPS show waiting cargo tagged with the line each item is "
			.. "queued for, plus inbound and outbound throughput.\n\n"
			...
			.. "TWO THINGS WORTH KNOWING. Produced, Shipped and Used are lifetime totals "
			.. "since the industry was built, not per-year rates - the game's per-period "
			.. "counters exist but are never filled in, so a rate cannot be read from them. "
			.. "And on industries with more than one input, Stored shows a combined total "
